         ...
         <div className="row align-items-center my-5">
            <div className="col-lg-12">   
                <h1 className="font-weight-light">Diario </h1> 
                    <p>
                    Tieni sotto controllo l'alimentazione1 del tuo cane. Con il diario alimentare puoi inserire i pasti e le quantità del tuo cane e monitorare le calorie necessarie per il suo fabbisogno.
                    </p>
            </div>
